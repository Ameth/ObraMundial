						...
						<div class="col-lg-12">
							<div class="ibox-content">
								...
								<div class="row m-b-md">
									<div class="col-lg-12">
										<a href="rpt_informe_publicadores.php?id=<?php echo base64_encode($Filtro); ?>&grp=<?php echo base64_encode($Grupo); ?>&prd=<?php echo base64_encode($Periodo); ?>" target="_blank" class="btn btn-outline btn-danger"><i class="fa fa-file-pdf-o"></i> Descargar en PDF</a>
