...
if(isset($_GET['Buscar'])&&$_GET['Buscar']!=""){
	$Filtro="and (NombreCongregacion LIKE '%".$_GET['Buscar']."%' Or Ciudad LIKE '%".$_GET['Buscar']."%')";
	$And=1;
}
           ...
           <div class="table-responsive">
			 <table class="table table-striped table-bordered table-hover dataTables-example" >
				...
				<tr>
                    ...
                    <td><a href="periodos.php?id=<?php echo base64_encode($row['IDPeriodo']);?>&tl=1" class="alkin btn btn-success btn-xs" title="Editar"><i class="fa fa-edit"></i> Editar</a></td>
				</tr>
					<?php }?>
				</tbody>
			   </table>
