...
<title>Precursores regulares | <?php echo NOMBRE_PORTAL;?></title>
<!-- InstanceEndEditable -->
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-sm-8">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <strong>Precursores regulares</strong>
                        </li>
                    </ol>
                </div>
               <?php  //echo $Cons;?>
         ...
         <div class="wrapper wrapper-content">
             <div class="row">
			    ...
			    <div class="ibox-content">
				  ...
				  <form action="informe_precursores_regulares.php" method="get" id="formBuscar" class="form-horizontal">
					   <div class="form-group">
					 	...
					 	<div class="form-group">
							...
							<div class="col-lg-3">
								<select name="Periodo" class="form-control m-b select2" id="Periodo" multiple data-placeholder="(Todos)">
