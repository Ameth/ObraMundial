										...
										<tbody>
											...
											?>
												<tr>
													...
													<td><input name="Publicaciones[]" autocomplete="off" type="text" class="form-control text-right mw-80 txt-resaltado" id="Publicaciones<?php echo $row['IDPublicador']; ?>" maxlength="3" onKeyUp="revisaCadena(this);" onKeyPress="return justNumbers(event,this.value);" value="<?php echo $row_Informes['Publicaciones']; ?>"></td>
													<td><input name="PresVideo[]" autocomplete="off" type="text" class="form-control text-right mw-80 txt-resaltado" id="PresVideo<?php echo $row['IDPublicador']; ?>" maxlength="3" onKeyUp="revisaCadena(this);" onKeyPress="return justNumbers(event,this.value);" value="<?php echo $row_Informes['Videos']; ?>"></td>
													<td><input name="Horas[]" autocomplete="off" type="text" class="form-control text-right mw-80 txt-resaltado" id="Horas<?php echo $row['IDPublicador']; ?>" maxlength="3" onKeyUp="revisaCadena(this);" onKeyPress="return justNumbers(event,this.value);" value="<?php echo $row_Informes['Horas']; ?>"></td>
													<td><input name="Revisitas[]" autocomplete="off" type="text" class="form-control text-right mw-80 txt-resaltado" id="Revisitas<?php echo $row['IDPublicador']; ?>" maxlength="3" onKeyUp="revisaCadena(this);" onKeyPress="return justNumbers(event,this.value);" value="<?php echo $row_Informes['Revisitas']; ?>"></td>
													<td><input name="Cursos[]" autocomplete="off" type="text" class="form-control text-right mw-80 txt-resaltado" id="Cursos<?php echo $row['IDPublicador']; ?>" maxlength="3" onKeyUp="revisaCadena(this);" onKeyPress="return justNumbers(event,this.value);" value="<?php echo $row_Informes['Cursos']; ?>"></td>
													<td><input name="Comentarios[]" autocomplete="off" type="text" class="form-control mw-130 txt-resaltado" id="Comentarios<?php echo $row['IDPublicador']; ?>" maxlength="50" value="<?php echo $row_Informes['Notas']; ?>"></td>
												</tr>
											<?php } ?>
											<?php if ($Num == 0) { ?>
