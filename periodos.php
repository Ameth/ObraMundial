					...
					<label class="col-lg-1 control-label">Año <span class="text-danger">*</span></label>
				  	<div class="col-lg-2">
                    	<select name="Anio" class="form-control" id="Anio" required="required" onChange="ValCodPeriodo();" <?php if($edit==1){ echo "disabled='disabled'";}?>>
							...
							<option value="2021" <?php if((isset($row['AnioPeriodo']))&&(strcmp($row['AnioPeriodo'],'2021')==0)){ echo "selected=\"selected\"";}?>>2021</option>
							<option value="2022" <?php if((isset($row['AnioPeriodo']))&&(strcmp($row['AnioPeriodo'],'2022')==0)){ echo "selected=\"selected\"";}?>>2022</option>
					...
					<label class="col-lg-1 control-label">Mes <span class="text-danger">*</span></label>
				  	<div class="col-lg-2">
                    	<select name="Mes" class="form-control" id="Mes" required="required" onChange="ValCodPeriodo();" <?php if($edit==1){ echo "disabled='disabled'";}?>>
							...
							<option value="3" <?php if((isset($row['MesPeriodo']))&&(strcmp($row['MesPeriodo'],'3')==0)){ echo "selected=\"selected\"";}?>>3 - Marzo</option>
							<option value="4" <?php if((isset($row['MesPeriodo']))&&(strcmp($row['MesPeriodo'],'4')==0)){ echo "selected=\"selected\"";}?>>4 - Abril</option>
							<option value="5" <?php if((isset($row['MesPeriodo']))&&(strcmp($row['MesPeriodo'],'5')==0)){ echo "selected=\"selected\"";}?>>5 - Mayo</option>
							<option value="6" <?php if((isset($row['MesPeriodo']))&&(strcmp($row['MesPeriodo'],'6')==0)){ echo "selected=\"selected\"";}?>>6 - Junio</option>
							<option value="7" <?php if((isset($row['MesPeriodo']))&&(strcmp($row['MesPeriodo'],'7')==0)){ echo "selected=\"selected\"";}?>>7 - Julio</option>
							<option value="8" <?php if((isset($row['MesPeriodo']))&&(strcmp($row['MesPeriodo'],'8')==0)){ echo "selected=\"selected\"";}?>>8 - Agosto</option>
							<option value="9" <?php if((isset($row['MesPeriodo']))&&(strcmp($row['MesPeriodo'],'9')==0)){ echo "selected=\"selected\"";}?>>9 - Septiembre</option>
							<option value="10" <?php if((isset($row['MesPeriodo']))&&(strcmp($row['MesPeriodo'],'10')==0)){ echo "selected=\"selected\"";}?>>10 - Octubre</option>
							<option value="11" <?php if((isset($row['MesPeriodo']))&&(strcmp($row['MesPeriodo'],'11')==0)){ echo "selected=\"selected\"";}?>>11 - Noviembre</option>
